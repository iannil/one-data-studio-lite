...
# 编辑 apps/backend/.env，填写 OPENAI_API_KEY 等配置

# 启动所有服务
docker-compose up -d

# 访问
# - 后端 API: http://localhost:3101/api/v1/docs
# - 前端: http://localhost:3100
# - Superset: http://localhost:3106
# - MinIO Console: http://localhost:3105
```
...
│       │   └── types/       # TypeScript 类型
│       └── package.json
├── services/                # 独立微服务 (MLflow, Label Studio, etc.)
